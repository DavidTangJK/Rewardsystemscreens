    ...
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="max-w-[95vw] w-full lg:max-w-7xl h-[95vh] flex flex-col p-0">
        <DialogHeader className="px-6 pt-6 pb-4 border-b shrink-0">
          <DialogTitle className="text-2xl">Customize {userName}'s Avatar</DialogTitle>
          <DialogDescription>
          ...
          <div className="flex-1 min-h-0 lg:w-3/4 flex flex-col">
            <Tabs defaultValue="face" className="flex-1 flex flex-col min-h-0">
              <TabsList className="grid w-full grid-cols-4 shrink-0 h-12 text-base mb-4">
                <TabsTrigger value="face" className="text-base">Face</TabsTrigger>
                <TabsTrigger value="hair" className="text-base">Hair</TabsTrigger>
                <TabsTrigger value="style" className="text-base">Style</TabsTrigger>
                <TabsTrigger value="colors" className="text-base">Colors</TabsTrigger>
              </TabsList>
              
              {/* Face Tab */}
              <TabsContent value="face" className="flex-1 overflow-y-auto pr-3 mt-0 space-y-8">
                <div>
                  <h3 className="mb-4 text-xl sticky top-0 bg-white py-2 z-10">Eyes</h3>
                ...
                <div>
                  <h3 className="mb-4 text-xl sticky top-0 bg-white py-2 z-10">Eyebrows</h3>
                  <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-4">
                ...
                <div>
                  <h3 className="mb-4 text-xl sticky top-0 bg-white py-2 z-10">Mouth</h3>
                  <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-4">
                ...
                <div className="pb-6">
                  <h3 className="mb-4 text-xl sticky top-0 bg-white py-2 z-10">Facial Hair</h3>
                  <div className="grid grid-cols-2 sm:grid-cols-3 gap-4">
              ...
              {/* Hair Tab */}
              <TabsContent value="hair" className="flex-1 overflow-y-auto pr-3 mt-0 space-y-8">
                <div>
                  <h3 className="mb-4 text-xl sticky top-0 bg-white py-2 z-10">Hair Style</h3>
                  <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-4">
                ...
                <div className="pb-6">
                  <h3 className="mb-4 text-xl sticky top-0 bg-white py-2 z-10">Hair Color</h3>
              ...
              {/* Style Tab */}
              <TabsContent value="style" className="flex-1 overflow-y-auto pr-3 mt-0 space-y-8">
                <div>
                  <h3 className="mb-4 text-xl sticky top-0 bg-white py-2 z-10">Glasses</h3>
                  <div className="grid grid-cols-2 sm:grid-cols-3 gap-4">
                ...
                <div>
                  <h3 className="mb-4 text-xl sticky top-0 bg-white py-2 z-10">Glasses Color</h3>
                  <div className="grid grid-cols-3 sm:grid-cols-4 md:grid-cols-5 gap-4">
                ...
                <div>
                  <h3 className="mb-4 text-xl sticky top-0 bg-white py-2 z-10">Earrings</h3>
                  <div className="grid grid-cols-2 sm:grid-cols-3 gap-4">
                ...
                <div>
                  <h3 className="mb-4 text-xl sticky top-0 bg-white py-2 z-10">Earring Color</h3>
                  <div className="grid grid-cols-3 sm:grid-cols-4 md:grid-cols-5 gap-4">
                ...
                <div>
                  <h3 className="mb-4 text-xl sticky top-0 bg-white py-2 z-10">Shirt Style</h3>
                  <div className="grid grid-cols-2 sm:grid-cols-3 gap-4">
                ...
                <div className="pb-6">
                  <h3 className="mb-4 text-xl sticky top-0 bg-white py-2 z-10">Shirt Color</h3>
                  <div className="grid grid-cols-3 sm:grid-cols-4 md:grid-cols-6 gap-4">
              ...
              {/* Colors Tab */}
              <TabsContent value="colors" className="flex-1 overflow-y-auto pr-3 mt-0 space-y-8">
                <div>
                  <h3 className="mb-4 text-xl sticky top-0 bg-white py-2 z-10">Skin Tone</h3>
                  <div className="grid grid-cols-2 sm:grid-cols-3 gap-4">
                ...
                <div className="pb-6">
                  <h3 className="mb-4 text-xl sticky top-0 bg-white py-2 z-10">Background Color</h3>
                  <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-4">
                    {avatarOptions.backgroundColors.map(bg => (
                      ...
                      >
                        <div 
                          className="w-16 h-16 rounded-2xl mx-auto mb-3 border-2 border-gray-200 shadow-md"
        ...
        <div className="flex gap-3 px-6 py-4 border-t shrink-0 bg-gray-50">
          ...
          <Button onClick={handleSave} className="flex-1 bg-gradient-to-r from-purple-500 to-pink-500" size="lg">
