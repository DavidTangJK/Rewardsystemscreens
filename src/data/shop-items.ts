export interface ShopItem {
  ...
  purchased: boolean;
  equipped: boolean;
  gridX?: number; // Grid position (0-29)
...
export const initialShopItems: ShopItem[] = [
  ...
  { id: 4, name: 'Bean Bag Chair', cost: 15, category: 'furniture', emoji: '🛋️', purchased: false, equipped: false, gridWidth: 3, gridHeight: 2 },
  ...
  // Games
  { id: 11, name: 'Gaming Console', cost: 50, category: 'games', emoji: '🎮', purchased: false, equipped: false, gridWidth: 2, gridHeight: 1 },
  { id: 12, name: 'Board Games', cost: 20, category: 'games', emoji: '🎲', purchased: true, equipped: true, gridWidth: 2, gridHeight: 1 },
  { id: 13, name: 'Puzzle Set', cost: 15, category: 'games', emoji: '🧩', purchased: false, equipped: false, gridWidth: 2, gridHeight: 1 },
  { id: 14, name: 'Card Games', cost: 10, category: 'games', emoji: '🃏', purchased: false, equipped: false, gridWidth: 1, gridHeight: 1 },
  
  // Toys
  { id: 15, name: 'Toy Box', cost: 15, category: 'toys', emoji: '🧸', purchased: false, equipped: false, gridWidth: 2, gridHeight: 2 },
  { id: 16, name: 'Art Supplies', cost: 18, category: 'toys', emoji: '🎨', purchased: false, equipped: false, gridWidth: 2, gridHeight: 1 },
  { id: 17, name: 'Soccer Ball', cost: 12, category: 'toys', emoji: '⚽', purchased: true, equipped: true, gridWidth: 1, gridHeight: 1 },
  { id: 18, name: 'Basketball', cost: 12, category: 'toys', emoji: '🏀', purchased: false, equipped: false, gridWidth: 1, gridHeight: 1 },
